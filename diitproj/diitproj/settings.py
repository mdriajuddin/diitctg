"""
Django settings for diitproj project.
...
SECRET_KEY = 'django-insecure-s^qez*gg9)s6he)*^9zxu6e_9+&t2wmb5^+qpvo+$=l6o36%6n'
...
WSGI_APPLICATION = 'diitproj.wsgi.application'
...
# Use email or username for login (optional)
ACCOUNT_AUTHENTICATION_METHOD = 'username'  # Or 'email' / 'username_email'
ACCOUNT_EMAIL_REQUIRED = True
ACCOUNT_USERNAME_REQUIRED = True

# Set allauth to skip email verification for simplicity
